...
(function (X, L) {
    ...
    L(a, "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u) {
        ...
        u = function () {
            ...
            w.prototype.dateFormat = function (c, l, e) {
                ...
                c = f(c, "%Y-%m-%d %H:%M:%S");
                var n = this, t = new this.Date(l), p = this.get("Hours", t), d = this.get("Day", t), k = this.get("Date", t), b = this.get("Month", t), g = this.get("FullYear", t), r = a.defaultOptions.lang, F = r && r.weekdays, D = r && r.shortWeekdays;
                t = y({
    ...
    L(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u) {
        var v = a.SVG_NS, H = u.attr, x = u.createElement, y = u.discardElement, G = u.error, B = u.isString, q = u.objectEach, h = u.splat;
        try {
    ...
    L(a, "Core/FormatUtilities.js", [a["Core/DefaultOptions.js"], a["Core/Utilities.js"]], function (a, u) {
        function v(a, f, c, e) {
            a = +a || 0;
            f = +f;
            var h = H.lang, m = (a.toString().split(".")[1] || "").split("e")[0].length, w = a.toString().split("e"), n = f;
    ...
    L(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y) {
        ...
        a = function () {
            ...
            a.prototype.css = function (b) {
                var d = this.styles, g = {}, k = this.element, c = ["textOutline", "textOverflow", "width"], r = "", a = !d;
            ...
            a.prototype.destroy = function () {
                var b = this, d = b.element || {}, g = b.renderer, k = d.ownerSVGElement, c = g.isSVG && "SPAN" === d.nodeName && b.parentGroup || void 0;
            ...
            a.prototype.getBBox = function (d, g) {
                var k = this.renderer, c = this.element, r = this.styles, l = this.textStr, e = k.cache, I = k.cacheKeys, F = c.namespaceURI === this.SVG_NS;
            ...
            a.prototype.setTextPath = function (b, d) {
                var k = this.element, Q = this.text ? this.text.element : k, r = {textAnchor: "text-anchor"}, a = !1, l = this.textPathWrapper, I = !l;
            ...
            a.prototype.updateTransform =
                function () {
                    var b = this.scaleX, d = this.scaleY, g = this.inverted, k = this.rotation, c = this.matrix, r = this.element, a = this.translateX || 0, l = this.translateY || 0;
        ...
        [a["Core/Utilities.js"]], function (a) {
            function v(a, q, h, f, c) {
                ...
                if (c) {
                    ...
                    var w = (c.end || 0) - .001;
                    f = c.innerR;
                    var n = G(c.open, .001 > Math.abs((c.end || 0) - t - 2 * Math.PI)), l = Math.cos(t), J = Math.sin(t), K = Math.cos(w), A = Math.sin(w);
    ...
    L(a, "Core/Renderer/SVG/TextBuilder.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a,
        ...
        return function () {
            ...
            h.prototype.modifyDOM = function () {
                ...
                if (h) {
                    var m = function (f, l) {
                        var n = f.textContent || "", w = n.replace(/([^\^])-/g, "$1- ").split(" "), m = !a.noWrap && (1 < w.length || 1 < c.element.childNodes.length), p = a.getLineHeight(l), d = 0, k = c.actualWidth;
    ...
    L(a, "Core/Renderer/SVG/SVGRenderer.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGLabel.js"], a["Core/Renderer/SVG/Symbols.js"], a["Core/Renderer/SVG/TextBuilder.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y, G, B, q, h) {
        var f = E.charts, c = E.deg2rad, e = E.doc, t = E.isFirefox, m = E.isMS, w = E.isWebKit, n = E.noop, l = E.SVG_NS, J = E.symbolSizes, K = E.win, A = h.addEvent,
            p = h.attr, d = h.createElement, k = h.css, b = h.defined, g = h.destroyObjectProperties, r = h.extend, F = h.isArray, D = h.isNumber, M = h.isObject, C = h.isString, O = h.merge, v = h.pick, W = h.pInt, Y = h.uniqueKey, ba;
        E = function () {
            ...
            z.prototype.button = function (b, d,
                                           g, k, c, z, l, e, f, F) {
                var I = this.label(b, d, g, f, void 0, void 0, F, void 0, "button"), Q = this.styledMode, P = 0, h = c ? O(c) : {};
                b = h && h.style || {};
            ...
            z.prototype.symbol = function (g, a, c, z, l, F) {
                var I = this, Q = /^url\((.*?)\)$/, h = Q.test(g), D = !h && (this.symbols[g] ? g : "circle"), n = D && this.symbols[D], C;
                if (n) {
    ...
    L(a, "Core/Renderer/HTML/HTMLElement.js", [a["Core/Globals.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function (a, u, E) {
        var v = this && this.__extends || function () {
            ...
            }(), x = a.isFirefox, y = a.isMS, G = a.isWebKit, B = a.win, q = E.css, h = E.defined, f = E.extend, c = E.pick, e = E.pInt;
        return function (a) {
            function m() {
            ...
            m.prototype.htmlUpdateTransform = function () {
                if (this.added) {
                    var a = this.renderer, c = this.element, l = this.translateX || 0, f = this.translateY || 0, m = this.x || 0, t = this.y || 0, p = this.textAlign || "left", d = {
                        left: 0,
                        center: .5,
                        right: 1
                    }[p], k = this.styles;
                    ...
                    if ("SPAN" === c.tagName) {
                        var b =
                            this.rotation, g = this.textWidth && e(this.textWidth), r = [b, p, c.innerHTML, this.textWidth, this.textAlign].join(), F = void 0;
            ...
            m.prototype.setSpanRotation = function (a, c, l) {
                var e = {}, f = y && !/Edge/.test(B.navigator.userAgent) ? "-ms-transform" : G ? "-webkit-transform" : x ? "MozTransform" : B.opera ? "-o-transform" : void 0;
    ...
    L(a, "Core/Axis/Tick.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u, E) {
        ...
        u = function () {
            ...
            m.prototype.addLabel = function () {
                var c = this, e = c.axis, l = e.options, m = e.chart, K = e.categories, A = e.logarithmic, p = e.names, d = c.pos, k = t(c.options && c.options.labels, l.labels), b = e.tickPositions, g = d === b[0], r = d === b[b.length - 1], F = (!k.step || 1 === k.step) && 1 === e.tickInterval;
                b = b.info;
                var D = c.label, M;
            ...
            m.prototype.getLabelPosition =
                function (a, c, l, e, f, m, p, d) {
                    var k = this.axis, b = k.transA, g = k.isLinked && k.linkedParent ? k.linkedParent.reversed : k.reversed, r = k.staggerLines, F = k.tickRotCorr || {
                            x: 0,
                            y: 0
                        }, D = e || k.reserveSpaceDefault ? 0 : -k.labelOffset * ("center" === k.labelAlign ? .5 : 1), n = {}, C = f.y;
            ...
            m.prototype.handleOverflow = function (a) {
                var c = this.axis, l = c.options.labels, e = a.x, f = c.chart.chartWidth, h = c.chart.spacing, p = t(c.labelLeft, Math.min(c.pos, h[3]));
                h = t(c.labelRight, Math.max(c.isRadial ?
                    0 : c.pos + c.len, f - h[1]));
                var d = this.label, k = this.rotation, b = {
                    left: 0,
                    center: .5,
                    right: 1
                }[c.labelAlign || d.attr("align")], g = d.getBBox().width, r = c.getSlotWidth(this), F = {}, D = r, M = 1, C;
            ...
            m.prototype.renderGridLine =
                function (a, c, e) {
                    var l = this.axis, f = l.options, h = {}, p = this.pos, d = this.type, k = t(this.tickmarkOffset, l.tickmarkOffset), b = l.chart.renderer, g = this.gridLine, r = f.gridLineWidth, F = f.gridLineColor, D = f.gridLineDashStyle;
            ...
            m.prototype.renderMark = function (a, c, e) {
                var l = this.axis, f = l.options, h = l.chart.renderer, p = this.type, d = l.tickSize(p ? p + "Tick" : "tick"), k = a.x;
                a = a.y;
    ...
    L(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"], a["Core/Color/Palette.js"], a["Core/DefaultOptions.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Utilities.js"], a["Core/Axis/AxisDefaults.js"], a["Core/Axis/Tick.js"]], function (a, u, E, H, x, y, G, B, q) {
        var h = a.animObject, f = x.registerEventOptions, c = y.deg2rad, e = H.defaultOptions, t = G.arrayMax, m = G.arrayMin, w = G.clamp, n = G.correctFloat, l = G.defined, J = G.destroyObjectProperties, v = G.erase,
            A = G.error, p = G.extend, d = G.fireEvent, k = G.getMagnitude, b = G.isArray, g = G.isNumber, r = G.isString, F = G.merge, D = G.normalizeTickInterval, M = G.objectEach, C = G.pick, O = G.relativeLength, S = G.removeEvent, W = G.splat, Y = G.syncTimeout;
        a = function () {
            function a(b, a) {
            ...
            a.prototype.defaultLabelFormatter = function (b) {
                ...
                var d = g(this.value) ? this.value : NaN, c = a.chart.time, k = this.dateTimeLabelFormat, r = e.lang, l = r.numericSymbols;
            ...
            a.prototype.getPlotLinePath = function (b) {
                ...
                var c = this, k = c.chart, r = c.left, e = c.top, l = b.old, f = b.value, z = b.lineWidth, h = l && k.oldChartHeight || k.chartHeight, F = l && k.oldChartWidth || k.chartWidth,
            ...
            a.prototype.getMinorTickPositions = function () {
                var b = this.options, a = this.tickPositions, d = this.minorTickInterval, g = this.pointRangePadding || 0, c = this.min - g;
                g = this.max + g;
                var k = g - c, r = [];
                if (k && k / d < this.len / 3) {
            ...
            a.prototype.setAxisTranslation = function () {
                var b = this, a = b.max - b.min, g = b.linkedParent, c = !!b.categories, k = b.isXAxis, e = b.axisPointRange || 0, l = 0, f = 0, h = b.transA;
                if (k || c || e) {
                    var F = b.getClosest();
            ...
            a.prototype.setTickInterval = function (b) {
                var a = this, c = a.chart, r = a.logarithmic, e = a.options, f = a.isXAxis, h = a.isLinked, F = e.tickPixelInterval, z = a.categories, p = a.softThreshold, M = e.maxPadding, m = e.minPadding, t = e.tickInterval, q = g(a.threshold) ? a.threshold : null;
            ...
            a.prototype.setTickPositions = function () {
                var b = this.options, a = b.tickPositions, g = this.getMinorTickInterval(), c = this.hasVerticalPanning(), k = "colorAxis" === this.coll, e = (k || !c) && b.startOnTick;
                c = (k || !c) && b.endOnTick;
                k = b.tickPositioner;
            ...
            a.prototype.adjustTickAmount = function () {
                var b = this.options, a = this.tickInterval, d = this.tickPositions, c = this.tickAmount, k = this.finalTickAmt, e = d && d.length, r = C(this.threshold, this.softThreshold ? 0 : null);
            ...
            a.prototype.zoom = function (b, a) {
                var g = this, c = this.dataMin, k = this.dataMax, e = this.options, r = Math.min(c, C(e.min, c)), f = Math.max(k, C(e.max, k));
                b = {newMin: b, newMax: a};
            ...
            a.prototype.setAxisSize = function () {
                var b = this.chart, a = this.options, d = a.offsets || [0, 0, 0, 0], g = this.horiz, c = this.width = Math.round(O(C(a.width, b.plotWidth - d[3] + d[1]), b.plotWidth)), k = this.height = Math.round(O(C(a.height, b.plotHeight - d[0] + d[2]), b.plotHeight)), e = this.top = Math.round(O(C(a.top, b.plotTop + d[0]), b.plotHeight, b.plotTop));
            ...
            a.prototype.tickSize = function (b) {
                var a = this.options, g = C(a["tick" === b ? "tickWidth" : "minorTickWidth"], "tick" === b && this.isXAxis && !this.categories ? 1 : 0), c = a["tick" === b ? "tickLength" : "minorTickLength"];
                if (g && c) {
            ...
            a.prototype.renderUnsquish = function () {
                var b = this.chart, a = b.renderer, d = this.tickPositions, g = this.ticks, c = this.options.labels, k = c.style, e = this.horiz, l = this.getSlotWidth(), f = Math.max(1, Math.round(l - 2 * c.padding)), h = {}, F = this.labelMetrics(), D = k.textOverflow, C = 0;
                r(c.rotation) ||
                ...
                d.forEach(function (b) {
                    ...
                    a && (a.attr(h), b.shortenLabel ? b.shortenLabel() : p && !d && "nowrap" !== k.whiteSpace && (p < a.textPxLength || "SPAN" === a.element.tagName) ? (c.width = p + "px", D || (c.textOverflow = a.specificTextOverflow || M), a.css(c)) : a.styles && a.styles.width && !c.width && !d && a.css({width: null}), delete a.specificTextOverflow, b.rotation = h.rotation)
                }, this);
            ...
            a.prototype.addTitle = function (b) {
                var a = this.chart.renderer, d = this.horiz, g = this.opposite, c = this.options.title, k = this.chart.styledMode, e;
            ...
            a.prototype.getOffset =
                function () {
                    var b = this, a = this, g = a.chart, c = g.renderer, k = a.options, e = a.tickPositions, r = a.ticks, f = a.horiz, h = a.side, F = g.inverted && !a.isZAxis ? [1, 0, 3, 2][h] : h, D = a.hasData(), p = k.title, n = k.labels, m = g.axisOffset;
                    g = g.clipOffset;
            ...
            a.prototype.getLinePath = function (b) {
                var a = this.chart, d = this.opposite, g = this.offset, c = this.horiz, k = this.left + (d ? this.width : 0) + g;
    ...
    L(a, "Core/Axis/PlotLineOrBand.js", [a["Core/Axis/Axis.js"], a["Core/Color/Palette.js"], a["Core/Utilities.js"]], function (a,
        ...
        var v = E.arrayMax, x = E.arrayMin, y = E.defined, G = E.destroyObjectProperties, B = E.erase, q = E.extend, h = E.fireEvent, f = E.isNumber, c = E.merge, e = E.objectEach, t = E.pick, m = function () {
            ...
            a.prototype.render = function () {
                h(this, "render");
                var a = this, l = a.axis, f = l.horiz, m = l.logarithmic, w = a.options, p = w.label, d = a.label, k = w.to, b = w.from, g = w.value, r = y(b) && y(k), F = y(g), D = a.svgElem, M = !D, C = [], q = w.color, v = t(w.zIndex, 0), W = w.events;
                C = {
    ...
    L(a, "Core/Tooltip.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function (a, u, E,
                                                                                                                                                                                        H, x) {
        var v = a.format, G = u.doc, B = x.clamp, q = x.css, h = x.defined, f = x.discardElement, c = x.extend, e = x.fireEvent, t = x.isArray, m = x.isNumber, w = x.isString, n = x.merge, l = x.pick, J = x.splat, K = x.syncTimeout, A = x.timeUnits;
        "";
        a = function () {
            function a(a, c) {
            ...
            a.prototype.getPosition = function (a, c, b) {
                ...
                }, q = n("y"), w = n("x"), v = !this.followPointer && l(b.ttBelow, !d.inverted === !!b.negative), A = function (b, a, d, g, c, r, l) {
            ...
            a.prototype.move = function (a, k, b, g) {
                var d = this, e = d.now, f = !1 !== d.options.animation && !d.isHidden && (1 < Math.abs(a - e.x) || 1 < Math.abs(k - e.y)), l = d.followPointer || 1 < d.len;
                c(e, {
                    x: f ? (2 * e.x + a) / 3 : a,
                    y: f ? (e.y + k) / 2 : k,
            ...
            a.prototype.refresh = function (a, c) {
                var b = this.chart, d = this.options, k = J(a), f = k[0], h = {}, p = [], C = d.formatter || this.defaultFormatter;
                h = this.shared;
                var m = b.styledMode;
                if (d.enabled) {
                    x.clearTimeout(this.hideTimer);
            ...
            a.prototype.renderSplit = function (a, k) {
                ...
                var d = this, e = d.chart, f = d.chart, h = f.chartWidth, p = f.chartHeight, C = f.plotHeight, m = f.plotLeft, t = f.plotTop, n = f.pointer, q = f.scrollablePixelsY;
                q = void 0 === q ? 0 : q;
                var v = f.scrollablePixelsX, A = f.scrollingContainer;
                A = void 0 === A ? {scrollLeft: 0, scrollTop: 0} : A;
                var J = A.scrollLeft;
                A = A.scrollTop;
                var K = f.styledMode, x = d.distance, y = d.options, I = d.options.positioner, N = d.outside && "number" !== typeof v ? G.documentElement.getBoundingClientRect() : {
                            left: J,
                            right: J + h,
                            top: A,
                            bottom: A + p
            ...
            a.prototype.tooltipFooterHeaderFormatter = function (a, c) {
                var b = c ? "footer" : "header", d = a.series, k = d.tooltipOptions, f = k.xDateFormat, l = d.xAxis, h = l && "datetime" === l.options.type && m(a.key), p = k[b + "Format"];
    ...
    L(a, "Core/Pointer.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Tooltip.js"], a["Core/Utilities.js"]], function (a, u, E, H, x) {
        var v = a.parse, G = u.charts, B = u.noop, q = x.addEvent, h = x.attr, f = x.css, c = x.defined, e = x.extend,
            t = x.find, m = x.fireEvent, w = x.isNumber, n = x.isObject, l = x.objectEach, J = x.offset, K = x.pick, A = x.splat;
        a = function () {
            function a(a, c) {
                this.lastValidTouch = {};
                this.pinchDown = [];
            ...
            a.prototype.drag = function (a) {
                var d = this.chart, b = d.options.chart, c = this.zoomHor, e = this.zoomVert, f = d.plotLeft, l = d.plotTop, h = d.plotWidth, C = d.plotHeight, p = this.mouseDownX || 0, m = this.mouseDownY || 0, t = n(b.panning) ? b.panning && b.panning.enabled : b.panning, q = b.panKey && a[b.panKey + "Key"], w = a.chartX, A = a.chartY, J = this.selectionMarker;
            ...
            a.prototype.drop = function (a) {
                ...
                if (this.selectionMarker) {
                    var r = {
                        ...
                        xAxis: [],
                        yAxis: []
                    }, l = this.selectionMarker, h = l.attr ? l.attr("x") : l.x, p = l.attr ? l.attr("y") : l.y, C = l.attr ? l.attr("width") : l.width, t = l.attr ? l.attr("height") : l.height, n;
                    if (this.hasDragged || g) b.axes.forEach(function (b) {
                        if (b.zoomEnabled && c(b.min) && (g || d[{
                            ...
                            var e =
                                b.horiz, k = "touchend" === a.type ? b.minPixelPadding : 0, f = b.toValue((e ? h : p) + k);
                ...
                function (a, c, b) {
                    ...
                    a.forEach(function (a) {
                        ...
                        if ((d = n(a, !0) && a.series) && !(d = !n(k, !0))) {
                            d = k.distX - a.distX;
                            var g = k.dist - a.dist, e = (a.series.group && a.series.group.zIndex) - (k.series.group && k.series.group.zIndex);
            ...
            a.prototype.pinchTranslateDirection = function (a, c, b, g, e, f, l, h) {
                var d = this.chart, k = a ? "x" : "y", r = a ? "X" : "Y", F = "chart" + r, p = a ? "width" : "height", m = d["plot" + (a ? "Left" : "Top")], D = d.inverted, t = d.bounds[a ? "h" : "v"], n = 1 === c.length, M = c[0][F], q = !n && c[1][F];
                c = function () {
            ...
            a.prototype.reset = function (a, c) {
                var b = this.chart, d = b.hoverSeries, e = b.hoverPoint, k = b.hoverPoints, f = b.tooltip, l = f && f.shared ? k : e;
            ...
            a.prototype.runPointActions = function (d, c) {
                var b = this.chart, g = b.tooltip && b.tooltip.options.enabled ? b.tooltip : void 0, e = g ? g.shared : !1, f = c || b.hoverPoint, k = f && f.series || b.hoverSeries;
    ...
    L(a, "Core/MSPointer.js", [a["Core/Globals.js"], a["Core/Pointer.js"], a["Core/Utilities.js"]], function (a, u, E) {
        ...
        var y = this && this.__extends || function () {
            ...
            a.doc, q = a.noop, h = a.win, f = E.addEvent, c = E.css, e = E.objectEach, t = E.removeEvent, m = {}, w = !!h.PointerEvent;
        return function (e) {
            function l() {
    ...
    L(a, "Core/Series/Point.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"],
        ...
        u = function () {
            ...
            g.prototype.optionsToObject = function (a) {
                var b = {}, d = this.series, c = d.options.keys, e = c || d.pointArrayMap || ["y"], f = e.length, k = 0, h = 0;
                if (l(a) || null === a) b[e[0]] = a; else if (w(a))for (!c && a.length > f && (d = typeof a[0], "string" === d ? b.name = a[0] : "number" === d && (b.x = a[0]), k++); h < f;)c && "undefined" === typeof a[k] || (0 < e[h].indexOf(".") ? g.prototype.setNestedProperty(b, a[k], e[h]) : b[e[h]] = a[k]), k++, h++; else"object" === typeof a && (b = a, a.dataLabels && (d._hasPointLabels = !0), a.marker && (d._hasPointMarkers = !0));
                return b
            };
            ...
            g.prototype.tooltipFormatter = function (a) {
                var b = this.series, d = b.tooltipOptions, c = p(d.valueDecimals, ""), g = d.valuePrefix || "", e = d.valueSuffix || "";
            ...
            g.prototype.setState = function (b, d) {
                var c = this.series, g = this.state, f = c.options.states[b || "normal"] || {}, k = q.plotOptions[c.type].marker && c.options.marker, h = k && !1 === k.enabled, r = k && k.states && k.states[b || "normal"] || {}, m = !1 === r.enabled, n = c.stateMarkerGraphic, F = this.marker || {}, w = c.chart, v = c.halo, A, J = k && c.markerAttribs;
                b = b || "";
        ...
        var d = function () {
            ...
            a.prototype.colorizeItem = function (a, d) {
                ...
                if (!this.chart.styledMode) {
                    var b = this.options, c = a.legendItem, g = a.legendLine, e = a.legendSymbol, f = this.itemHiddenStyle.color;
            ...
            a.prototype.positionCheckboxes = function () {
                var a = this.group && this.group.alignAttr, d = this.clipHeight || this.legendHeight, e = this.titleHeight;
                if (a) {
                    var f = a.translateY;
            ...
            a.prototype.renderItem = function (a) {
                var b = this.chart, d = b.renderer, c = this.options, e = this.symbolWidth, f = c.symbolPadding || 0, k = this.itemStyle, h = this.itemHiddenStyle, p = "horizontal" === c.layout ? J(c.itemDistance, 20) : 0, m = !c.rtl, t = a.legendItem, n = !a.series, q = !n && a.series.drawLegendSymbol ? a.series : a, w = q.options, v = this.createCheckboxForItem && w && w.showCheckbox;
                w = e + f + p + (v ? 20 : 0);
            ...
            a.prototype.layoutItem = function (a) {
                var b = this.options, d = this.padding, c = "horizontal" === b.layout, e = a.itemHeight, f = this.itemMarginBottom, k = this.itemMarginTop, l = c ? J(b.itemDistance, 20) : 0, h = this.maxLegendWidth;
            ...
            a.prototype.handleOverflow = function (a) {
                ...
                var l = e.maxHeight, h, m = this.clipRect, p = e.navigation, t = J(p.animation, !0), n = p.arrowSize || 12, w = this.nav, q = this.pages, v, A = this.allItems, I = function (a) {
            ...
            a.prototype.setItemEvents = function (a, d, c) {
                var b =
                    this, e = b.chart.renderer.boxWrapper, g = a instanceof H, f = "highcharts-legend-" + (g ? "point" : "series") + "-active", k = b.chart.styledMode;
    ...
    L(a, "Core/Chart/Chart.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/FormatUtilities.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Legend.js"], a["Core/MSPointer.js"],
        ...
        var w = a.animate, n = a.animObject, l = a.setAnimation, v = E.numberFormat, K = H.registerEventOptions, A = x.charts, p = x.doc, d = x.marginNames, k = x.win, b = B.defaultOptions, g = B.defaultTime, r = c.seriesTypes, F = t.addEvent, D = t.attr, M = t.cleanRecursively, C = t.createElement,
            O = t.css, S = t.defined, W = t.discardElement, Y = t.erase, ba = t.error, z = t.extend, Q = t.find, L = t.fireEvent, aa = t.getStyle, ja = t.isArray, I = t.isNumber, N = t.isObject, P = t.isString, U = t.merge, T = t.objectEach, R = t.pick, V = t.pInt, ca = t.relativeLength, da = t.removeEvent, fa = t.splat, ea = t.syncTimeout, ka = t.uniqueKey;
        a = function () {
            function a(a, b, d) {
            ...
            a.prototype.isInsidePlot = function (a, b, d) {
                void 0 ===
                d && (d = {});
                var c = this.inverted, e = this.plotBox, g = this.plotLeft, f = this.plotTop, k = this.scrollablePlotBox, l = 0;
                var h = 0;
            ...
            a.prototype.redraw = function (a) {
                L(this, "beforeRedraw");
                var b = this.hasCartesianSeries ? this.axes : this.colorAxis || [], d = this.series, c = this.pointer, e = this.legend, g = this.userOptions.legend, f = this.renderer, k = f.isHidden(), h = [], I = this.isDirtyBox, r = this.isDirtyLegend;
                this.setResponsive &&
            ...
            a.prototype.reflow = function (a) {
                var b = this, d = b.options.chart, c = b.renderTo, e = S(d.width) && S(d.height), g = d.width || aa(c, "width");
            ...
            a.prototype.setChartSize = function (a) {
                var b = this.inverted, d = this.renderer, c = this.chartWidth, e = this.chartHeight, g = this.options.chart, f = this.spacing, k = this.clipOffset, l, h, I, r;
            ...
            a.prototype.showResetZoom =
                function () {
                    ...
                    var d = this, c = b.lang, e = d.options.chart.resetZoomButton, g = e.theme, f = g.states, k = "chart" === e.relativeTo || "spacingBox" === e.relativeTo ? null : "scrollablePlotBox";
            ...
            a.prototype.zoom = function (a) {
                ...
                !a || a.resetSelection ? (b.axes.forEach(function (a) {
                        ...
                        var f = a.axis, k = b.inverted ? f.left : f.top, l = b.inverted ? k + f.width : k + f.height, h = f.isXAxis, I = !1;
                ...
                L(this, "pan", {originalEvent: a}, function () {
                    ...
                    b.forEach(function (b) {
                        if (b.options.panningEnabled && !b.options.isInternal) {
                            ...
                            var h = d[c], r = b.minPointOffset || 0, p = b.reversed && !d.inverted || !b.reversed && d.inverted ? -1 : 1, m = b.getExtremes(), t = b.toValue(h - l, !0) + r * p, n = b.toValue(h + b.len - l, !0) - (r * p || b.isXAxis && b.pointRangePadding || 0), P = n < t;
    ...
    L(a, "Mixins/LegendSymbol.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u) {
        ...
        return a.LegendSymbolMixin = {
            drawRectangle: function (a, v) {
                ...
                var u = this.options, x = u.marker, B = a.symbolWidth, q = a.symbolHeight, h = q / 2, f = this.chart.renderer, c = this.legendGroup;
    ...
    L(a, "Core/Series/Series.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Mixins/LegendSymbol.js"], a["Core/DefaultOptions.js"], a["Core/Color/Palette.js"], a["Core/Series/Point.js"],
        ...
        a = function () {
            ...
            a.prototype.getCyclic = function (a, d, c) {
                var e = this.chart, g =
                    this.userOptions, f = a + "Index", k = a + "Counter", l = c ? c.length : z(e.options.chart[a + "Count"], e[a + "Count"]);
                if (!d) {
                    var h = z(g[f], g["_" + f]);
            ...
            a.prototype.updateData = function (a, d) {
                var c = this.options, e = c.dataSorting, g = this.points, f = [], k, l, h, r = this.requireSorting, p = a.length === g.length, m = !0;
            ...
            a.prototype.setData = function (a, b, d, c) {
                var e = this, g = e.points, f = g && g.length || 0, k, l = e.options, h = e.chart, p = l.dataSorting, m = null, t = e.xAxis;
                m = l.turboThreshold;
            ...
            a.prototype.generatePoints = function () {
                var a = this.options, b = a.data, d = this.data, c, e = this.processedXData, g = this.processedYData, f = this.pointClass, k = e.length, l = this.cropStart || 0, h = this.hasGroupedData, r = a.keys, m = [], p;
            ...
            a.prototype.translate = function () {
                ...
                this.generatePoints();
                var a = this.options, d = a.stacking, c = this.xAxis, e = c.categories, g = this.enabledDataSorting, f = this.yAxis, l = this.points, h = l.length, r = !!this.modifyValue, m, t = this.pointPlacementToXValue(), n = !!t, q = a.threshold, w = a.startFromThreshold ? q : 0, A, v = this.zoneAxis || "y", C = Number.MAX_VALUE;
                for (m = 0; m < h; m++) {
                    var u = l[m], F = u.x, D = u.y, J = u.low, B = d && f.stacking && f.stacking.stacks[(this.negStacks && D < (w ? 0 : q) ? "-" : "") + this.stackKey], x = void 0, K = void 0;
            ...
            a.prototype.getClipBox = function (a, b) {
                var d = this.options, c = this.chart, e = c.inverted, g = this.xAxis, f = g && this.yAxis, k = c.options.chart.scrollablePlotArea || {};
                a && !1 === d.clip && f ? a = e ? {
            ...
            a.prototype.setClip = function (a) {
                var b = this.chart, d = this.options, c = b.renderer, e = b.inverted,
                    g = this.clipBox, f = this.getClipBox(a), k = this.getSharedClipKey(a), l = b.sharedClips[k], h = b.sharedClips[k + "m"];
            ...
            a.prototype.drawPoints = function () {
                var a = this.points, b = this.chart, d, c, e = this.options.marker, g = this[this.specialGroup] || this.markerGroup, f = this.xAxis, k = z(e.enabled, !f || f.isRadial ? !0 : null, this.closestPointRangePx >= e.enabledThreshold * e.radius);
            ...
            a.prototype.markerAttribs = function (a, b) {
                var d = this.options, c = d.marker, e = a.marker || {}, g = e.symbol || c.symbol, f = z(e.radius, c.radius);
            ...
            a.prototype.applyZones = function () {
                var a = this, b = this.chart, d = b.renderer, c = this.zones, e, g, f = this.clips || [], k, l = this.graph, h = this.area, r = Math.max(b.chartWidth, b.chartHeight), m = this[(this.zoneAxis || "y") + "Axis"], t = b.inverted, n, q, w, A = !1, v, u;
            ...
            a.prototype.render = function () {
                var a = this, b = a.chart, d = a.options,
                    c = f(d.animation), e = !a.finishedAnimating && b.renderer.isSVG && c.duration, g = a.visible ? "inherit" : "hidden", k = d.zIndex, l = a.hasRendered, h = b.seriesGroup, p = b.inverted;
                M(this, "render");
            ...
            a.prototype.addPoint = function (a, b, d, c, e) {
                ...
                var t = r.x;
                var n = p.length;
                if (this.requireSorting && t < p[n - 1])for (m = !0; n && p[n - 1] > t;)n--;
            ...
            a.prototype.setState = function (a, b) {
                var d = this, c = d.options, e = d.graph, g = c.inactiveOtherPoints, f = c.states, k = c.lineWidth,
                    l = c.opacity, h = z(f[a || "normal"] && f[a || "normal"].animation, d.chart.options.chart.animation);
                c = 0;
                a = a || "";
        ...
        [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Axis/StackingAxis.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y, G) {
            ...
            x.prototype.setStackedPoints = function (a) {
                ...
                if (e && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                    var f = this.processedXData, n = this.processedYData, t = [], p = n.length, d = this.options, k = d.threshold, b = m(d.startFromThreshold && k, 0);
                    d = d.stack;
                    a = a ? this.type + "," + e : this.stackKey;
                    var g = "-" + a, r = this.negStacks, v = this.yAxis, u = v.stacking.stacks, B = v.stacking.oldStacks, C, x;
    ...
    L(a, "Series/Area/AreaSeries.js", [a["Core/Color/Color.js"], a["Mixins/LegendSymbol.js"],
        ...
        H = function (a) {
            ...
            c.prototype.drawGraph = function () {
                ...
                var c = this, f = this.areaPath, m = this.options, q = [["area", "highcharts-area", this.color, m.fillColor]];
            ...
            c.prototype.getStackPoints = function (a) {
                var c = this, e = [], f = [],
                    n = this.xAxis, l = this.yAxis, v = l.stacking.stacks[this.stackKey], u = {}, A = l.series, p = A.length, d = l.options.reversedStacks ? 1 : -1, k = A.indexOf(c);
                a = a || this.points;
    ...
    L(a, "Series/Column/ColumnSeries.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"],
        ...
        B = function (a) {
            ...
            d.prototype.animate = function (a) {
                var b = this, d = this.yAxis, c = b.options, f = this.chart.inverted, k = {}, l = f ? "translateX" : "translateY";
                if (a) k.scaleY =
            ...
            d.prototype.getColumnMetrics = function () {
                ...
                var p = Math.min(Math.abs(c.transA) * (c.ordinal && c.ordinal.slope ||
                    d.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), m = p * d.groupPadding, t = (p - 2 * m) / (h || 1);
            ...
            d.prototype.translate = function () {
                ...
                var k = a.xAxis, l = a.yAxis, h = c.threshold, p = a.translatedThreshold = l.getThreshold(h), t = A(c.minPointLength, 5), n = a.getColumnMetrics(), q = n.width, v = a.barW = Math.max(q, 1 + 2 * f), u = a.pointXOffset = n.offset, w = a.dataMin, x = a.dataMax;
                d.inverted && (p -= .5);
            ...
            d.prototype.pointAttribs = function (a, d) {
                ...
                var e = c.stroke ||
                    "borderColor";
                var g = c["stroke-width"] || "borderWidth", k = a && a.color || this.color, l = a && a[e] || b[e] || k, h = a && a[g] || b[g] || this[g] || 0;
    ...
    L(a, "Mixins/CenteredSeries.js", [a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Utilities.js"]], function (a, u, E) {
        ...
        return a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, q = this.chart, h = 2 * (a.slicedOffset || 0), f = q.plotWidth - 2 * h, c = q.plotHeight - 2 * h, e = a.center, t = Math.min(f, c), m = a.size, v = a.innerSize || 0;
    ...
    L(a, "Series/Pie/PiePoint.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function (a, u, E) {
        ...
        E = function (a) {
            ...
            c.prototype.getConnectorPath = function () {
                var a = this.labelPosition, c = this.series.options.dataLabels, f = c.connectorShape, h = this.connectorShapes;
                h[f] && (f = h[f]);
            ...
            h =
                function (a) {
                    ...
                    h.prototype.translate = function (a) {
                        this.generatePoints();
                        var e = 0, d = this.options, f = d.slicedOffset, b = f + (d.borderWidth || 0), g = c(d.startAngle, d.endAngle), h = this.startAngleRad = g.start;
    ...
    L(a, "Core/Series/DataLabels.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y, G) {
        ...
        var h = G.arrayMax, f = G.clamp, c = G.defined, e =
            G.extend, t = G.fireEvent, m = G.isArray, w = G.merge, n = G.objectEach, l = G.pick, J = G.relativeLength, K = G.splat, A = G.stableSort;
        "";
        ...
        x.prototype.drawDataLabels = function () {
            ...
            var e = this, b = e.chart, f = e.options, h = f.dataLabels, u = e.points, x, A = e.hasRendered || 0, C = h.animation;
            ...
            if (m(h) || h.enabled || e._hasPointLabels) {
                ...
                u.forEach(function (g) {
                    ...
                    x.forEach(function (d, k) {
                        var h = d.enabled && (!g.isNull || g.dataLabelOnNull) && a(g, d), m = g.dataLabels ? g.dataLabels[k] : g.dataLabel, p = g.connectors ? g.connectors[k] : g.connector, r = l(d.distance, g.labelDistance), t = !m;
                        if (h) {
        ...
        x.prototype.alignDataLabel = function (a, c, f, b, g) {
            var d = this, k = this.chart, h = this.isCartesian && k.inverted, m = this.enabledDataSorting, p = l(a.dlBox && a.dlBox.centerX, a.plotX, -9999), n = l(a.plotY, -9999), q = c.getBBox(), t = f.rotation, v = f.align, u = k.isInsidePlot(p, Math.round(n), {
                inverted: h,
                paneCoordinates: !0,
                series: d
            }), w = "justify" === l(f.overflow, m ? "none" : "justify"), x = this.visible && !1 !== a.visible && (a.series.forceDL || m && !w || u || l(f.inside, !!this.options.stacking) && b && k.isInsidePlot(p, h ? b.x + 1 : b.y +
        ...
        y.pie && (y.pie.prototype.dataLabelPositioners = {
            ...
            var a = this, d = a.data, e, b = a.chart, f = a.options.dataLabels || {}, m = f.connectorPadding, n, q = b.plotWidth, t = b.plotHeight, v = b.plotLeft, u = Math.round(b.chartWidth / 3), A, y = a.center, B = y[2] / 2, G = y[1], z, J, K, L, X = [[], []], I, N, P, U, T = [0, 0, 0, 0], R = a.dataLabelPositioners, V;
        ...
        y.column && (y.column.prototype.alignDataLabel = function (a, c, e, b, f) {
            var d = this.chart.inverted,
                g = a.series, h = a.dlBox || a.shapeArgs, k = l(a.below, a.plotY > l(this.translatedThreshold, g.yAxis.len)), m = l(e.inside, !!this.options.stacking);
