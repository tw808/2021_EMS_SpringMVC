...
<form action="/eval/update.do" method="post" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="evalId" readonly="readonly"
                           class="form-control input-sm"
                           value="${evaluation.evalId}" placeholder="enter id"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="evalTitle"
                           value="${evaluation.evalTitle}" class="form-control input-sm" placeholder="enter"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="evalCourse"
                           value="${evaluation.evalCourse}" class="form-control input-sm" placeholder="enter"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select name="evalTeacher" class="form-control input-sm">
                        <c:forEach items="${sList}" var="staff">
                            <option value="${staff.staffName}"
                                ${staff.staffName==evaluation.evalTeacher ? 'selected':''} >
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input  type="text" name="evalTime"
                            value="<fmt:formatDate value="${evaluation.evalTime}" type="both" pattern="yyyy-MM-dd"/>"                            onClick="WdatePicker()"  readonly="readonly"  class="Wdate form-control input-sm"
                ...
                <div class="col-sm-6">
                    <select name="stuId" class="form-control input-sm">
                        <c:forEach items="${stList}" var="student">
                            <option value="${student.stuId}" ${student.stuId==evaluation.stuId ? 'selected':''}>${student.stuName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control input-sm"
                              name="evalContent" placeholder="enter evaluation">${evaluation.evalContent}
                    </textarea>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-5 col-sm-offset-4">
            ...
            <a href="/eval/list.do" class="btn btn-warning">back</a>
