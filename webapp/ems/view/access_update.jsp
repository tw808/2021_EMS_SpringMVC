...
<form action="/access/update.do" method="post" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="accessId" value="${acc.accessId}" class="form-control input-sm"
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="accessName" value="${acc.accessName}" class="form-control input-sm"
    ...
    <div class="row">
                    ...
                    <select  name="accessPid"  class="form-control input-sm">
                        <c:forEach items="${alist}" var="list">
                            <option value="${list.accessId}"
                                ${list.accessId==acc.accessPid?'selected':''}>
                                    ${list.accessName}
                            </option>
                        </c:forEach>
                    </select></div>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="accessUrl" value="${acc.accessUrl}" class="form-control input-sm"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea name="accessDesc" class="form-control input-sm"
                              placeholder="enter description">${acc.accessDesc}</textarea>
                </div>
            </div>
        </div>
    </div>
