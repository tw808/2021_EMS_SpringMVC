...
<form action="/salary/update.do" method="post" class="form-horizontal">
    <!--<-->
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="staffSalId" value="${salary.staffSalId}" readonly="readonly" class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="paid"value="${salary.paid}" class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <select name="staStaffId" class="form-control input-sm">
                        <c:forEach items="${sList}" var="staff1">
                            <option value="${staff1.staffId}"
                                ${staff1.staffId==salary.staStaffId ? 'selected':''}>${staff1.staffName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                    ...
                    <select name="staffId" class="form-control input-sm">
                        <c:forEach items="${sList}" var="staff">
                            <option value="${staff.staffId}"
                                ${staff.staffId==salary.staffId ? 'selected':''}>${staff.staffName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="totalSal" value="${salary.totalSal}"
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="deductSal" value="${salary.deductSal}"
                           class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="realSal" value="${salary.realSal}"
                           class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                <label class="col-sm-5 control-label">Net</label>
                <div class="col-sm-6">
                    <input type="text" name="staffSalTime" onClick="WdatePicker()"
                           value="<fmt:formatDate value="${salary.staffSalTime}" type="both" pattern="yyyy-MM-dd"/>"                             readonly="readonly" class="Wdate form-control input-sm"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control input-sm" name="staffSalRemark"
                              placeholder="enter Content">${salary.staffSalRemark}</textarea>
                </div>
            </div>
        </div>
    </div>
