...
<%--additional info--%>
    <h5 class="page-header alert-info" style="padding: 10px;margin: 0px; margin-bottom: 5px">Tracking
        Information <input type="button" class="btn btn-block btn-xs"
                           value="Add" onclick=
                "javascript:window.location='/track/loadAdd.do'"/></h5>
    <div class="row">
        <div class="col-sm-10">
            <table class="table">
                <tr>
                ...
                <c:forEach items="${tList}" var="track">
                    <tr>
                        <td>${track.trackRecTitle}</td>
                        <td>${track.trackRecContent}</td>
                        <td>${track.dataInfo}</td>
                        <td><fmt:formatDate value="${track.trackRecTime}"/></td>
                        <td><fmt:formatDate value="${track.nextRecTime}"/></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
    ...
    <%--additional info--%>
    <h5 class="page-header alert-info" style="padding: 10px;margin: 0px; margin-bottom: 5px">Audit
        Information  <input type="button" class="btn btn-block btn-xs"
                            value="Add" onclick=
                "javascript:window.location='/audition/loadAdd.do'"/></h5>
    <div class="row">
        <div class="col-sm-10">
            <table class="table">
                <tr>
                ...
                <c:forEach items="${aList}" var="audit">
                    <tr>
                        <td>${audit.audCourse}</td>
                        <td><fmt:formatDate value="${audit.audTime}"/></td>
                        <td>${audit.audAddr}</td>
                        <td>${audit.audDesc}</td>
                    </tr>
                </c:forEach>
    ...
    <div class="row">
        <div class="col-sm-5 col-sm-offset-4">
            ...
            <a href="/recruitStu/list.do" class="btn btn-warning">back</a>
