...
<form action="/discipline/add.do" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="discId" class="form-control input-sm" placeholder="enter id"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="discName" class="form-control input-sm" placeholder="enter discipline"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="discTuition" class="form-control input-sm" placeholder="enter cost"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="discTime" class="form-control input-sm" placeholder="enter hours"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control input-sm"  name="discDesc"  placeholder="enter information"></textarea>
                </div>
            </div>
        </div>
    </div>
