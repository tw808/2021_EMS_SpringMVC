...
<form action="/grade/add.do" method="post" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="stuGradeId" readonly="readonly" class="form-control input-sm" placeholder="enter id"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="stuGradeSub" class="form-control input-sm" placeholder="enter"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                        <input type="text" name="stuGrade" class="form-control input-sm" placeholder="enter"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="stuGradeTime" onClick="WdatePicker()" value="2000-01-01"
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control input-sm" name="stuGradeNote" placeholder="enter Content"></textarea>
                </div>
            </div>
        </div>
    </div>
