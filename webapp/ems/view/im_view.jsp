    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <p class="form-control-static">${iinfo.staffName}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <fmt:formatDate value="${iinfo.imSendTime}" type="both" pattern="yyyy-MM-dd"/>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <p class="form-control-static">${iinfo.imReceiver}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                <label class="col-sm-5 control-label">Receiver #</label>
                <div class="col-sm-6">
                    <p class="form-control-static">${iinfo.imReceiverCell}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <p class="form-control-static">${iinfo.imContent}</p>
                </div>
            </div>
        </div>
    </div>
