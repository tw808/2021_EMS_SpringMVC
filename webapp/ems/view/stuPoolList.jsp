...
<div class="row alert alert-info" style="margin:0px;padding:5px;">
    <form action="/stuPool/list.do" method="post" class="form-horizontal">
        ...
        <input type="button" class="btn btn-success" value="Add" onclick=
                "javascript:window.location='ems/view/stuPoolAdd.jsp'"/>
    </form>
</div>
...
<div class="row" style="padding:0px;padding-left: 15px;padding-right: 15px;" align="right">
    <display:table class="table table-condensed table-striped" name="list"
                   pagesize="10" requestURI="/stuPool/list.do">
        <display:column property="stuId" title="Id"/>
        <display:column href="/stuPool/show.do" property="stuName" title="Name"
        ...
        <display:column href="/stuPool/load.do?stuId=${studentInfo.stuId}"
                        paramId="stuId" paramProperty="stuId" value="edit" title="edit"/>
        <display:column href="/stuPool/get.do?stuId=${studentInfo.stuId}"
                        paramId="stuId" paramProperty="stuId" value="recruit" title="recruit"/>
        <display:column href="/stuPool/delete.do?stuId=${studentInfo.stuId}"
