...
<form action="/grade/update.do" method="post" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="stuGradeId" value="${grade.stuGradeId}"
                           readonly="readonly" class="form-control input-sm" placeholder="enter id"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
                    ...
                    <select name="stuId" class="form-control input-sm">
                        <c:forEach items="${stList}" var="student">
                            <option value="${student.stuId}"
                                ${student.stuId==grade.stuId ? 'selected':''}>${student.stuName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="stuGradeSub"  value="${grade.stuGradeSub}" class="form-control input-sm" placeholder="enter"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="stuGrade"  value="${grade.stuGrade}"
    ...
    <div class="row">
                    ...
                    <select name="staffId" class="form-control input-sm">
                        <c:forEach items="${sList}" var="staff">
                            <option value="${staff.staffId}"
                                ${staff.staffId==grade.staffId ? 'selected':''}>${staff.staffName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="stuGradeTime" onClick="WdatePicker()"
                           value="<fmt:formatDate value="${grade.stuGradeTime}" type="both" pattern="yyyy-MM-dd"/>"                             readonly="readonly" class="Wdate form-control input-sm"
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control input-sm" name="stuGradeNote" placeholder="enter Content">${grade.stuGradeNote}</textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-5 col-sm-offset-4">
            ...
            <a href="/grade/list.do" class="btn btn-warning">back</a>
        </div>
    </div>
</form>
</body>
