...
<form action="/template/edit.do" method="post" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="templateId"  value="${tinfo.templateId}" class="form-control input-sm"
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="templateTitle" value="${tinfo.templateTitle}"
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select name="templateEngine" class="form-control input-sm">
                        <option ${tinfo.templateEngine=='Message'?'selected':''}>Instant Message</option>
                        <option ${tinfo.templateEngine=='Email'?'selected':''}>Email</option>
                    </select>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea name="templateContent" class="form-control input-sm"
                              placeholder="enter description">${tinfo.templateContent}</textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-5 col-sm-offset-4">
            ...
            <a href="/template/list.do" class="btn btn-warning">back</a>
