    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input readonly="readonly" type="text" name="templateId" class="form-control input-sm"
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea name="templateContent" class="form-control input-sm" placeholder="enter description"></textarea>
                </div>
            </div>
        </div>
    </div>
