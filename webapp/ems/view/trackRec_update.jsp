...
<form action="/track/update.do" method="post" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="trackRecId" readonly="readonly" value="${trackInfo.trackRecId}"
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="trackRecTitle" value="${trackInfo.trackRecTitle}"
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="stuId" class="form-control input-sm" value="${trackInfo.stuName}">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="trackRecTime" onClick="WdatePicker()"
                           value="<fmt:formatDate value="${trackInfo.trackRecTime}" type="both" pattern="yyyy-MM-dd"/>"
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" name="nextRecTime" onClick="WdatePicker()"
                           value="<fmt:formatDate value="${trackInfo.nextRecTime}" type="both" pattern="yyyy-MM-dd"/>"
                           readonly="readonly" class="Wdate form-control input-sm" placeholder="enter date"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                <label class="col-sm-5 control-label">Student</label>
                <div class="col-sm-6">
                    <s:select type="stu_status" id="dataInfo" name="trackRecEnroll"
                              selectedId="${trackInfo.trackRecEnroll}"></s:select>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control input-sm"
                              name="trackRecContent" placeholder="enter information">${trackInfo.trackRecContent} </textarea>
                </div>
            </div>
        </div>
    </div>
