...
<form action="/dataDictionary/edit.do"  method="post" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input readonly="readonly" type="text" name="dataId" value="${dataDictionary.dataId}" class="form-control input-sm"
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="dataInfo" value="${dataDictionary.dataInfo}"  class="form-control input-sm"
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="dataEngine" value="${dataDictionary.dataEngine}"  class="form-control input-sm"
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control input-sm" name="dataDiscr" placeholder="enter description">${dataDictionary.dataDiscr} </textarea>
                </div>
            </div>
        </div>
    </div>
