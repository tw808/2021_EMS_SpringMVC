...
<div class="row alert alert-info" style="margin:0px;padding:5px;">
    <form action="/roleinfo/list.do" method="post" class="form-horizontal">
        ...
        <input type="button" class="btn btn-success" value="Add" onclick=
                "javascript:window.location='ems/view/roleinfo_add.jsp'"/>
    </form>
</div>
...
<div class="row" style="padding:0px;padding-left: 15px;padding-right: 15px;" align="right">
    <display:table class="table table-condensed table-striped" name="rlist"
                   pagesize="10" requestURI="/roleinfo/list.do">
        ...
        <display:column property="roleStatus" title="Status"/>
        <display:column href="/roleinfo/load.do"
                        paramId="roleId" paramProperty="roleId" value="edit" title="edit"/>
        <display:column href="/roleinfo/delete.do"
