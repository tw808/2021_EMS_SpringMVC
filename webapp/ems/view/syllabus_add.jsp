...
<form action="/syllabus/add.do"  method="post" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="syllId" class="form-control input-sm" placeholder="enter id"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="syllName" class="form-control input-sm" placeholder="enter name"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" name="syllMon" class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-7">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" name="syllTue" class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" name="syllWed" class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-7">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" name="syllThur" class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" name="syllFri" class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-7">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" name="syllSat" class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" name="syllSun" class="form-control input-sm" placeholder="enter "/>
                </div>
            </div>
        </div>
    </div>
