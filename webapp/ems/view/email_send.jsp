...
<form action="/em/send.do" method="post" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" id="templateTitle"  name="emTitle" class="form-control input-sm"
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text"  name="emReceiver" class="form-control input-sm"
                           placeholder="enter data description"/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="emReceiverEm" class="form-control input-sm"
                           placeholder="enter data description"/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea id="templateContent" name="emMsg" class="form-control input-sm" placeholder="enter description"></textarea>
                </div>
            </div>
        </div>
    </div>
