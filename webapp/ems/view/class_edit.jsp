    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="classId" class="form-control input-sm"
                           value="${classInfo.classId}" placeholder="enter id"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="className" class="form-control input-sm"
                           value="${classInfo.className}" placeholder="enter name"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input  type="text" name="classStart" value="<fmt:formatDate value="${classInfo.classStart}" type="both" pattern="yyyy-MM-dd"/>"
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input  type="text" name="classEnd" value="<fmt:formatDate value="${classInfo.classEnd}" type="both" pattern="yyyy-MM-dd"/>"
                            onClick="WdatePicker()"  readonly="readonly"  class="Wdate form-control input-sm"
                            placeholder="enter date"/>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="classNum" class="form-control input-sm"
                           value="${classInfo.classNum}" placeholder="enter"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
                    ...
                    <select  name="staffId"  class="form-control input-sm">
                        <c:forEach items="${sList}" var="staff">
                            <option value="${staff.staffId}"
                                ${staff.staffId==classInfo.staffId ? 'selected':''}>
                                    ${staff.staffName}
                            </option>
                        </c:forEach>
                    </select>
                ...
                <div class="col-sm-5">
                    <select name="discId" class="form-control input-sm">
                        <c:forEach items="${dList}" var="discipline">
                            <option value="${discipline.discId}"
                                ${discipline.discId==classInfo.discId ? 'selected':''}>
                                    ${discipline.discName}
                            </option>
                        </c:forEach>
                    </select>
                ...
                <div class="col-sm-5">
                    <select name="syllId" class="form-control input-sm">
                        <c:forEach items="${syList}" var="syllabus">
                            <option value="${syllabus.syllId}"
                                ${syllabus.syllId==classInfo.syllId ? 'selected':''}>
                                    ${syllabus.syllName}
                            </option>
                        </c:forEach>
                    </select>
                    ...
                    <select name="classroomId" class="form-control input-sm">
                        <c:forEach items="${cList}" var="classroom">
                            <option value="${classroom.classroomId}"
                                ${classroom.classroomId==classInfo.classroomId ? 'selected':''}>
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control input-sm" name="classDesc" placeholder="enter information">
                        ${classInfo.classDesc}
                    </textarea>
                </div>
            </div>
