...
<div class="row alert alert-info" style="margin:0px;padding:5px;">
    <form action="/teacher/list.do" method="post" class="form-horizontal">
        ...
        <input type="button" class="btn btn-success" value="Add" onclick=
                "javascript:window.location='ems/view/teacher_add.jsp'"/>
    </form>
</div>
<%--confirm info--%>
...
<div class="row" style="padding:0px;padding-left: 15px;padding-right: 15px;" align="right">
    <display:table class="table table-condensed table-striped" name="list"
                   pagesize="10" requestURI="teacher/list.do" >
        <display:column property="staffId" title="Staff Id"/>
        <display:column href="/teacher/show.do" property="staffName" title="Name"
        ...
        <display:column href="/teacher/load.do?staffId=${staffInfo.staffId}"
                        paramId="staffId" paramProperty="staffId" value="edit" title="edit"/>
        <display:column href="/teacher/delete.do?staffId=${staffInfo.staffId}"
